...
public record UIConstraint(ViewMain context, Supplier<Boolean> visibilitySupplier, Supplier<String> titleSupplier,
                           Supplier<String> descriptionSupplier) implements UIComponent {
    public UIConstraint {
